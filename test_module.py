...
class UnitTests(unittest.TestCase):
    ...
    def test_period_change_at_twelve(self):
        ...
        expected = "12:05 PM"
        self.assertEqual(
            actual, expected, "Expected period to change from AM to PM at 12:00"
        )
    ...
    def test_two_days_later(self):
        ...
        self.assertEqual(
            actual,
            expected,
            'Expected calling "add_time()" with "11:59 PM",'
            ' "24:05" to return "12:04 AM (2 days later)"',
        )
    ...
    def test_high_duration(self):
        ...
        self.assertEqual(
            actual,
            expected,
            'Expected calling "add_time()" with "8:16 PM",'
            ' "466:02" to return "6:18 AM (20 days later)"',
        )
    ...
    def test_no_change(self):
        ...
        expected = "5:01 AM"
        self.assertEqual(
            actual, expected, "Expected adding 0:00 to return initial time."
        )
    ...
    def test_same_period_with_day(self):
        ...
        self.assertEqual(
            actual,
            expected,
            'Expected calling "add_time()" with "3:30 PM",'
            ' "2:12", "Monday" to return "5:42 PM, Monday"',
        )
    ...
    def test_twenty_four_with_day(self):
        ...
        self.assertEqual(
            actual,
            expected,
            'Expected calling "add_time()" with "2:59 AM",'
            ' "24:00", "saturDay" to return "2:59 AM, Sunday (next day)"',
        )
    ...
    def test_two_days_later_with_day(self):
        ...
        self.assertEqual(
            ...
            expected,
            'Expected calling "add_time()" with "2:59 AM",'
            ' "24:00", "Friday" to return "12:04 AM, Friday (2 days later)"',
        )
    ...
    def test_high_duration_with_day(self):
        ...
        self.assertEqual(
            ...
            expected,
            'Expected calling "add_time()" with "8:16 PM",'
            ' "466:02", "tuesday" to return "6:18 AM, Monday (20 days later)"',
        )
